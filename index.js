...
const run = async() => {
    const modulefolders = ['components', 'guards', 'models', 'pages', 'services', 'specs', 'styles'];
    ...
    console.log(chalk.greenBright('Successfully created folders and files for this module', emoji.get('sunglasses')));
    console.log(chalk.greenBright('speed is of the essence', emoji.get('smiley'), emoji.get('rocket')));
